...
VALUES ('kit27.ad05@gmail.com', 'e732b7307246a8c9c7b036af9dd05b94573825b16233cea33e5375a3772515ac')
...
-- Note: In this architecture, the backend uses the anon key to perform operations.
-- For production, it is highly recommended to use the service_role key instead.
GRANT SELECT, INSERT, UPDATE, DELETE ON users TO anon;
GRANT SELECT, INSERT, UPDATE, DELETE ON loans TO anon;
GRANT USAGE ON SEQUENCE users_id_seq TO anon;
GRANT USAGE ON SEQUENCE loans_id_seq TO anon;
